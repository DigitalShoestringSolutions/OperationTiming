...
class LocationState(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['item_id',],name="location_item_idx"),
            models.Index(fields=['location_link',"item_id","end"], name="location_loc_link_idx"),
            models.Index(fields=['-start','-end'], name="location_timestamp_idx"),
        ]
